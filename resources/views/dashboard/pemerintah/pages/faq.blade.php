                ...
                <tbody>
                    ...
                    <tr class="alokasi-rows bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td data-id="{{ $faq->id }}" class="py-4 flex flex-row justify-start pe-2">
                            ...
                            <button data-modal-target="deleteAlokasiModal" data-modal-toggle="deleteAlokasiModal" onclick="deleteFaqPassId(this,'{{ csrf_token() }}')" class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-red-400 border border-red-400">Hapus</button>
                        </td>
                    </tr>
                    @endforeach
