...
<td class="py-4 flex flex-row px-6" data-id="{{ $laporan->id }}">
    ...
    @if($laporan->status_verifikasi == 'Belum Diverifikasi')
        <button type="button" onclick="verifikasiLaporanPassId(this,'Ori')" class="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-blue-400 border border-blue-400">Setujui</button>
        <button type="button"onclick="tolakLaporanPassId(this,'Ori')" class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-red-400 border border-red-400">Tolak</button>
    @endif
</td>