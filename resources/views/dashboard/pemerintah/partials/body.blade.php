...
<div class="wrapper relative">
    ...
    <div id="alert-1" class="absolute z-[100] left-1/2 transform -translate-x-1/2 top-5 flex items-center p-4 mb-4 text-blue-800 border  border-blue-300  dark:border-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
