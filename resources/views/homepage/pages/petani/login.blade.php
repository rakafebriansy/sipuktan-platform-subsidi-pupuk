          ...
          <form action="/petani/login" method="POST">
            ...
            <div class="grid">
              <div class="mb-5">
                ...
                <input type="text" @if (isset($_COOKIE['nik'])) value="{{ $_COOKIE['nik'] }}" @else value="{{ old('nik','') }}" @endif name="nik" id="nik" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" />
              </div>
              <div class="mb-5">
                ...
                <input type="password" name="kata_sandi" @isset($_COOKIE['sipuktan_kata_sandi_petani']) value="{{ $_COOKIE['sipuktan_kata_sandi_petani'] }}" @endisset id="kata_sandi" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" />
              </div> 
